...
function startBuyNowCheckout(productId, size, qty) {
  ...
  openCenteredPopup('checkout.html', 'checkout', 550, 900);
}
...
/**
 * Returns all confirmed orders, with expired delivered receipts removed.
 */
...
/**
 * Saves a new confirmed order after checkout.
 */
