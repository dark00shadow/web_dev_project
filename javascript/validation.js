...
const patterns = {
    ...
    location: /^.{5,200}$/ // Simple address pattern (min 5 chars)
};
...
function setupLoginValidation() {
    ...
    const checkFormValidity = () => {
        const isUserValid = patterns.email.test(usernameInput.value.trim());
    ...
    usernameInput.addEventListener('blur', () => validateField(usernameInput, patterns.email, "Please enter a valid email address."));
    ...
    usernameInput.addEventListener('input', () => handleInput(usernameInput, patterns.email, "Please enter a valid email address."));
    ...
    form.addEventListener('submit', (e) => {
        ...
        // But just in case:
        const isUserValid = validateField(usernameInput, patterns.email, "Please enter a valid email address.");
        const isPassValid = validateField(passwordInput, patterns.password, "Password is invalid or too short.");

        // Validation is handled by login.js, no need for alert here
    });
}
...
function setupRegisterValidation() {
    ...
    // Validation is handled by register.js, no need for submit handler here
}
